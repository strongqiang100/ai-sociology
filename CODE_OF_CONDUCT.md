...
This project discusses subjects that touch people's livelihoods, identities and anxieties. **Disagreeing
with a judgement is expected; dismissing the person who made it is not.**
...
- Publishing others' private information, such as a physical or email address, without their
  explicit permission
- **Presenting another contributor's work as one's own**, or republishing this project's content
  while stripping attribution
- **Weaponising the framework's content to sell certainty** — for example repackaging a forecast as
...
appropriate and fair corrective action in response to any behaviour that they deem inappropriate,
...
maintainers by opening a private channel of contact:

- **Preferred**: send a direct message to the maintainer [@strongqiang100](https://github.com/strongqiang100) on GitHub
- **Alternative**: open an issue titled `[conduct] <short summary>` without naming individuals, so a
  private channel can be established

All complaints will be reviewed and investigated promptly and fairly. All maintainers are obligated to
...
involved for a specified period of time. This includes avoiding interactions in community spaces as
