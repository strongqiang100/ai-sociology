...
这是一份理论研究工作论文。各项推演注明前提、可能出现的相反结果和检验办法，尚待经验研究的部分保留为假说。研究关心的是：当许多事情更容易做到，人能否因此获得更多可支配的时间、更可靠的关系，以及选择自己生活的余地。

**关键词：** 人工智能；有限注意；稀缺性；情绪调节；任务重组；社会比较；委托关系；博弈；制度；价值多元。

### 作者说明

作者以“AI社会学”署名，在中国杭州一家人工智能公司工作。本文整理自产品工作中的观察、理论阅读与实践记录，所述观点由作者个人负责。经验材料与公开研究的关系见第五卷。
...
**引用建议：** AI社会学（2026）。《AI社会学：人的有限性、生成的扩张与社会秩序的重组》。研究版 0.1.0，工作论文，2026-09-22。引用具体命题时请附章节或编号，并记录所用版本。完整书目信息见[参考文献](REFERENCES.md)。
