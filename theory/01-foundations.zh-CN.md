...
注意力研究解释信息供给为何受制于接收能力；社会比较研究解释评价标准为何随参照群体改变；信号理论讨论能力不易观察时，人们怎样借助学历、作品与声誉作判断；任务理论区分技术对某项工作的替代，以及新需求、新任务带来的机会。它们关注不同环节，不能被一个“效率提高”的判断代替。[R01、R03、R05、R09]

把这些理论放在一起，可以追问一条更完整的变化过程：生成成本下降后，供给如何变化，注意怎样分配，质量怎样辨认，报酬又由谁决定？博弈论进一步考察参与者如何根据彼此的行动调整策略，制度研究则解释规则如何改变这些行动的成本、收益与可行范围。相同的技术进入不同组织与社会，因而未必产生相同后果。[R12–R14]
...
第五组问题涉及理论本身：哪些变量实际可以合并，哪些重要因素仍然缺席？哪些机制只是相同现象的不同描述？哪些推演会被新的证据推翻？一种解释若只能容纳支持它的例子，而不能回答这些问题，就还不足以成为可靠的理论。
